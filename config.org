...
#+begin_src emacs-lisp
  ...
  (use-package doom-themes
    :straight t
    :init (load-theme 'doom-solarized-dark)
  )
...
#+begin_src emacs-lisp
  ...
  ;; I think I also need to add to sql-connections-alist
...
#+begin_src emacs-lisp
      (use-package copilot
        ...
        :ensure t
        :init (setq copilot-node-executable "/Users/patrickfoley/.asdf/installs/nodejs/17.9.1/bin/node")
        :config (
