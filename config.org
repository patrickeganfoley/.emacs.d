...
(use-package
 ...
 (setq forge-topic-view-fetch-comments t))

(setq auth-sources '("~/.authinfo"))
(setq auth-source-cache-expiry 0)
(setq auth-source-debug t)
;;(setq forge-topic-list-limit '(60 . 20))      ; (owned . others)
;;(setq forge-owned-accounts '("patrickeganfoley"))
#+end_src
...
;; ;; Prefer tree-sitter Python and keep LSP working
;; (when (and (fboundp 'python-ts-mode) (boundp 'major-mode-remap-alist))
;;   (add-to-list
...
;; Ensure polymode never auto-initializes (prevents pm--mode-setup recursion)
(with-eval-after-load 'polymode
  (ignore-errors
    (pm-global-mode -1))
  (remove-hook 'after-change-major-mode-hook #'pm--mode-setup))
